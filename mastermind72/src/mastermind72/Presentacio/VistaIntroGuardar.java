...
public class VistaIntroGuardar extends javax.swing.JFrame {
    ...
    private void setDefaultHint(){
        nomPartida.setFont(new java.awt.Font("Century SchoolBook L", 2, 14));
    ...
    private void initComponents() {
        ...
        getContentPane().add(butCancel, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 170, 120, 40));
        ...
        getContentPane().add(butAccept, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 170, 120, 40));

        nomPartida.setFont(new java.awt.Font("Century Schoolbook L", 2, 14)); // NOI18N
        ...
        getContentPane().add(titol, new org.netbeans.lib.awtextra.AbsoluteConstraints(45, 20, -1, 30));
    ...
    private void nomPartidaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nomPartidaKeyPressed
        if (first && evt.getKeyCode() != 8){ //No comptem backspaces
            ...
            nomPartida.setFont(new java.awt.Font("Century SchoolBook L", 1, 14));
