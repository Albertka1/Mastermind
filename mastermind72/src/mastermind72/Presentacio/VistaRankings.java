...
public class VistaRankings extends javax.swing.JFrame {
    ...
    private void setRanking(String dif){
        ...
        for (Pair<String,Integer> r : rankings){
            ...
            nom.setFont(new java.awt.Font("Century Schoolbook L", 1, 24));
            ...
            punct.setFont(new java.awt.Font("Century Schoolbook L", 1, 24));
    ...
    private void initComponents() {
        ...
        punctuation.setFont(new java.awt.Font("Century Schoolbook L", 1, 30)); // NOI18N
        ...
        getContentPane().add(punctuation, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 180, -1, -1));

        name.setFont(new java.awt.Font("Century Schoolbook L", 1, 30)); // NOI18N
        ...
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 220, 690, 10));
        ...
        getContentPane().add(titol, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 74, -1, 80));
