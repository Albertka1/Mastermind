...
public class VistaNovaPartida extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        titol.setFont(new java.awt.Font("Century Schoolbook L", 1, 64)); // NOI18N
        titol.setForeground(new java.awt.Color(255, 255, 255));
        titol.setText("New Game");
        getContentPane().add(titol, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 80, -1, -1));

        difText.setFont(new java.awt.Font("Century Schoolbook L", 1, 36)); // NOI18N
        difText.setForeground(new java.awt.Color(255, 255, 255));
        difText.setText("Set dificulty:");
        getContentPane().add(difText, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 190, -1, 50));

        butEasy.setBackground(javax.swing.UIManager.getDefaults().getColor("ComboBox.buttonShadow"));
        butEasy.setFont(new java.awt.Font("Century Schoolbook L", 1, 24)); // NOI18N
        ...
        getContentPane().add(butEasy, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 200, 210, 40));

        butDif.setBackground(javax.swing.UIManager.getDefaults().getColor("ComboBox.buttonShadow"));
        butDif.setFont(new java.awt.Font("Century Schoolbook L", 1, 24)); // NOI18N
        ...
        getContentPane().add(butDif, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 200, 200, 40));

        difInfo.setFont(new java.awt.Font("Century Schoolbook L", 2, 24)); // NOI18N
        difInfo.setForeground(new java.awt.Color(204, 204, 204));
        difInfo.setDoubleBuffered(true);
        getContentPane().add(difInfo, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 250, 500, 80));

        modeText.setFont(new java.awt.Font("Century Schoolbook L", 1, 36)); // NOI18N
        modeText.setForeground(new java.awt.Color(255, 255, 255));
        modeText.setText("Set mode:");
        getContentPane().add(modeText, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 340, -1, 40));

        butBreaker.setBackground(javax.swing.UIManager.getDefaults().getColor("ComboBox.buttonShadow"));
        butBreaker.setFont(new java.awt.Font("Century Schoolbook L", 1, 24)); // NOI18N
        ...
        getContentPane().add(butBreaker, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 340, 210, 40));

        butMaker.setBackground(javax.swing.UIManager.getDefaults().getColor("ComboBox.buttonShadow"));
        butMaker.setFont(new java.awt.Font("Century Schoolbook L", 1, 24)); // NOI18N
        ...
        getContentPane().add(butMaker, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 340, 200, 40));

        modeInfo.setFont(new java.awt.Font("Century Schoolbook L", 2, 24)); // NOI18N
        ...
        juga.setFont(new java.awt.Font("Century Schoolbook L", 1, 36)); // NOI18N
        juga.setText("PLAY!");
