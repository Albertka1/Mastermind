...
public class VistaAjuda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        butClose.setFont(new java.awt.Font("Century Schoolbook L", 0, 24)); // NOI18N
        ...
        getContentPane().add(butClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 630, 200, 40));
        ...
        infoMaker.setFont(new java.awt.Font("Century Schoolbook L", 1, 16)); // NOI18N
        ...
        getContentPane().add(panelMaker, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 470, 270, 140));
        ...
        infoMode.setFont(new java.awt.Font("Century Schoolbook L", 1, 16)); // NOI18N
        ...
        getContentPane().add(panelMode, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 140, 270, 140));
        ...
        infoBreak.setFont(new java.awt.Font("Century Schoolbook L", 1, 16)); // NOI18N
        ...
        getContentPane().add(panelBreak, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 310, 280, 140));
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 460, 460, 10));
        getContentPane().add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 300, 460, 10));
        ...
        getContentPane().add(gifMaker, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 470, -1, -1));
        ...
        titol.setFont(new java.awt.Font("Century Schoolbook L", 1, 48)); // NOI18N
        titol.setForeground(new java.awt.Color(255, 255, 255));
        titol.setText("Help");
        getContentPane().add(titol, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 20, -1, 70));
