...
public class ControladorPresentacio {
    ...
    public List<Pair<List<Integer>,Pair<Integer,Integer>>> cridaControladorPartida_JugarPartidaCM(){
        return cPartida.jugarPartidaCM();
    }
    ...
    public Boolean cridaControladorPartida_getHaDemanatAjuda(){
        return cPartida.getHaDemanatAjuda();
    }
