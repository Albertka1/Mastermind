...
public class VistaPartida extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        butHelp.setFont(new java.awt.Font("Century Schoolbook L", 0, 18)); // NOI18N
        ...
        butExit.setFont(new java.awt.Font("Century Schoolbook L", 0, 18)); // NOI18N
        ...
        butAccept.setFont(new java.awt.Font("Century Schoolbook L", 1, 24)); // NOI18N
    ...
    private void butHelpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butHelpActionPerformed
        int bolaAmbAjuda = -1;
        Boolean haDemanatAjuda = cPresentacio.cridaControladorPartida_getHaDemanatAjuda();
        ...
        else if (!haDemanatAjuda)
        {
            ...
            // No ha introduit cap jugada encara
            javax.swing.JOptionPane.showMessageDialog(rootPane, "Ja has demanat ajuda.");
        }
