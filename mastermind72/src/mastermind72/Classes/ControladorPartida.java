...
public class ControladorPartida {
    ...
    public List<Pair<List<Integer>,Pair<Integer,Integer>>> jugarPartidaCM(){
        return partida.jugarPartidaCM();
    }
    public int getBolaAmbAjuda(){
       return partida.bolaAmbAjuda();
    }
    public Boolean getHaDemanatAjuda(){
       return partida.getDemanatAjuda();
    }
