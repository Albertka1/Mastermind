...
public class VistaIntroGuardar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(butCancel, new AbsoluteConstraints(80, 170, 110, 40));
        ...
        getContentPane().add(butAccept, new AbsoluteConstraints(310, 170, 110, 40));
        ...
        getContentPane().add(nomPartida, new AbsoluteConstraints(40, 80, 420, 40));

        titol.setFont(new java.awt.Font("Ebrima", 0, 18)); // NOI18N
        titol.setText("Introdueix el nom per a guardar la teva partida:");
        getContentPane().add(titol, new AbsoluteConstraints(63, 20, -1, 30));
