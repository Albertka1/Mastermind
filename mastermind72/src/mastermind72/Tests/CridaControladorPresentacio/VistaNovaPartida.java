...
public class VistaNovaPartida extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(titol, new AbsoluteConstraints(90, 80, 320, 50));
        ...
        getContentPane().add(difText, new AbsoluteConstraints(210, 200, -1, -1));
        ...
        getContentPane().add(butEasy, new AbsoluteConstraints(460, 200, 120, 40));
        ...
        getContentPane().add(butDif, new AbsoluteConstraints(610, 200, 150, 40));
        ...
        getContentPane().add(difInfo, new AbsoluteConstraints(460, 250, 450, 80));
        ...
        getContentPane().add(modeText, new AbsoluteConstraints(260, 340, -1, -1));
        ...
        getContentPane().add(butBreaker, new AbsoluteConstraints(460, 340, 190, 40));
        ...
        getContentPane().add(butMaker, new AbsoluteConstraints(690, 340, 190, 40));
        ...
        getContentPane().add(modeInfo, new AbsoluteConstraints(460, 390, 450, 80));
        ...
        getContentPane().add(juga, new AbsoluteConstraints(395, 530, 230, 60));
        ...
        getContentPane().add(back, new AbsoluteConstraints(890, 590, 90, 80));

        wrongPlayDif.setFont(new java.awt.Font("Ebrima", 1, 18)); // NOI18N
        wrongPlayDif.setForeground(new java.awt.Color(204, 0, 0));
        getContentPane().add(wrongPlayDif, new AbsoluteConstraints(320, 600, 380, 50));
        ...
        getContentPane().add(wrongPlayMode, new AbsoluteConstraints(320, 600, 380, 50));
        ...
        getContentPane().add(fondo, new AbsoluteConstraints(0, 0, 1024, 700));
