...
public class VistaAjuda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(butClose, new AbsoluteConstraints(150, 620, 200, 40));
        ...
        getContentPane().add(panelMaker, new AbsoluteConstraints(210, 470, 260, 110));
        ...
        getContentPane().add(panelMode, new AbsoluteConstraints(210, 160, 270, 90));
        ...
        getContentPane().add(panelBreak, new AbsoluteConstraints(40, 320, 260, 110));
        getContentPane().add(jSeparator1, new AbsoluteConstraints(30, 440, 460, 10));
        getContentPane().add(jSeparator2, new AbsoluteConstraints(30, 310, 460, 10));
        ...
        getContentPane().add(gifMode, new AbsoluteConstraints(40, 100, -1, -1));

        gifMaker.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mastermind72/Presentacio/images/introMakerRes.gif"))); // NOI18N
        getContentPane().add(gifMaker, new AbsoluteConstraints(40, 460, -1, -1));
