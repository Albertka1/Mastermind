...
public class VistaRankings extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(butDif, new AbsoluteConstraints(622, 590, 190, 40));
        ...
        getContentPane().add(butEasy, new AbsoluteConstraints(208, 590, 190, 40));
        ...
        getContentPane().add(punctuation, new AbsoluteConstraints(650, 180, -1, -1));

        name.setFont(new java.awt.Font("Centaur", 1, 30)); // NOI18N
        name.setForeground(new java.awt.Color(255, 255, 255));
        name.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        name.setText("Name");
        getContentPane().add(name, new AbsoluteConstraints(260, 180, -1, -1));

        panelRecords.setBackground(new java.awt.Color(39, 39, 44));
        panelRecords.setLayout(new AbsoluteLayout());
        getContentPane().add(panelRecords, new AbsoluteConstraints(170, 230, 690, 350));
        getContentPane().add(jSeparator1, new AbsoluteConstraints(170, 220, 670, 10));
        ...
        getContentPane().add(titol, new AbsoluteConstraints(90, 74, -1, -1));
        ...
        getContentPane().add(fondo, new AbsoluteConstraints(0, 0, -1, 700));
