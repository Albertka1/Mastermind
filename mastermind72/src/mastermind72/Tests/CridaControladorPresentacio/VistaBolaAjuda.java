...
public class VistaBolaAjuda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(titol, new AbsoluteConstraints(30, 20, 240, 44));

        bola.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mastermind72/Presentacio/images/solucMarronDestac.png"))); // NOI18N
        getContentPane().add(bola, new AbsoluteConstraints(110, 110, -1, -1));
        ...
        getContentPane().add(jButton1, new AbsoluteConstraints(65, 260, 170, 40));
