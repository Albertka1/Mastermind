...
public class VistaCarregarPartida extends javax.swing.JFrame {
    ...
    public void setPartides(){
        ...
        for (Pair<String,String> r : l){//1-2018_01_05-13_29_48
                final JTextField nom = new JTextField(r.getRight()+"   -   "
    ...
    private void initComponents() {
        ...
        getContentPane().add(butLoad, new AbsoluteConstraints(640, 610, 190, 40));

        name.setFont(new java.awt.Font("Centaur", 1, 30)); // NOI18N
        name.setForeground(new java.awt.Color(255, 255, 255));
        name.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        name.setText("Choose a game to load");
        getContentPane().add(name, new AbsoluteConstraints(170, 200, -1, -1));
        ...
        getContentPane().add(panelPartides, new AbsoluteConstraints(150, 250, 710, 340));
        ...
        getContentPane().add(info, new AbsoluteConstraints(90, 160, 790, 30));
        getContentPane().add(jSeparator1, new AbsoluteConstraints(170, 240, 670, 10));
