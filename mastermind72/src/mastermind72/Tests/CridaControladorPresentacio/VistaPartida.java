...
public class VistaPartida extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(butHelp, new AbsoluteConstraints(540, 560, 210, 80));
        ...
        getContentPane().add(butExit, new AbsoluteConstraints(750, 560, 210, 80));
        ...
        getContentPane().add(butAccept, new AbsoluteConstraints(540, 470, 420, 80));
        ...
        getContentPane().add(solucio, new AbsoluteConstraints(40, 470, 480, 80));
        ...
        getContentPane().add(disponibles, new AbsoluteConstraints(40, 560, 480, 60));
        ...
        getContentPane().add(tableroScroll, new AbsoluteConstraints(40, 110, 930, 340));
        ...
        getContentPane().add(infoTop, new AbsoluteConstraints(60, 50, 850, -1));
