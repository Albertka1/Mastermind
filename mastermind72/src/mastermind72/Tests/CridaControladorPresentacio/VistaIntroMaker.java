...
public class VistaIntroMaker extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(butCancel, new AbsoluteConstraints(80, 230, 110, 40));
        ...
        getContentPane().add(butAccept, new AbsoluteConstraints(310, 230, 110, 40));
        ...
        getContentPane().add(repeatInfo, new AbsoluteConstraints(15, 260, 470, 30));

        titol.setFont(new java.awt.Font("Ebrima", 0, 18)); // NOI18N
        titol.setText("Introdueix la solució que vols que la màquina resolgui: ");
        getContentPane().add(titol, new AbsoluteConstraints(30, 20, -1, 30));
        ...
        getContentPane().add(disponibles, new AbsoluteConstraints(10, 150, 480, 60));
        ...
        getContentPane().add(solucio, new AbsoluteConstraints(20, 60, 460, 80));
