...
public class VistaMenuGuardar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(titol, new AbsoluteConstraints(95, 20, -1, 30));
        ...
        getContentPane().add(advertencia, new AbsoluteConstraints(60, 50, -1, 30));
        ...
        getContentPane().add(butCancel, new AbsoluteConstraints(40, 110, 110, 40));
        ...
        getContentPane().add(butSI, new AbsoluteConstraints(350, 110, 110, 40));
        ...
        getContentPane().add(butNO, new AbsoluteConstraints(195, 110, 110, 40));
