...
public class VistaMenuPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(NewGame, new AbsoluteConstraints(345, 240, 330, 80));
        ...
        getContentPane().add(LoadGame, new AbsoluteConstraints(345, 350, 330, 80));
        ...
        getContentPane().add(ExitApp, new AbsoluteConstraints(390, 630, 240, 40));
        ...
        getContentPane().add(SeeRanks, new AbsoluteConstraints(345, 460, 330, 80));

        titulo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mastermind72/Presentacio/images/logo.png"))); // NOI18N
        getContentPane().add(titulo, new AbsoluteConstraints(210, 60, 600, 140));
        ...
        getContentPane().add(about, new AbsoluteConstraints(940, 30, -1, -1));
        ...
        getContentPane().add(help, new AbsoluteConstraints(970, 30, -1, -1));
